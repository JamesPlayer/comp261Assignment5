...
public class Assignment5 {
	...
	private void initialise() {
		...
		searchAlgorithm = new JComboBox<>(SEARCH_ALGORITHMS);
		searchAlgorithm.setMaximumSize(searchAlgorithm.getPreferredSize());
		...
		searchField.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (searchAlgorithm.getSelectedIndex() == 0) {					
					System.out.println("Using KMP");
					index = new KMP(pattern, text).search(pattern, text);
				} else {
					System.out.println("Using Brute Force");
					index = new Search(pattern, text).search(pattern, text);
				}
